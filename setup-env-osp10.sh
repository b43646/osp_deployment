...
curl -o /tmp/open.repo http://classroom/open10.repo
...
vbmc add undercloud --username admin --password admin --port 6230
vbmc add overcloud-ctrl01 --username admin --password admin --port 6231
vbmc add overcloud-ctrl02 --username admin --password admin --port 6232
vbmc add overcloud-ctrl03 --username admin --password admin --port 6233
vbmc add overcloud-compute01 --username admin --password admin --port 6234
vbmc add overcloud-compute02 --username admin --password admin --port 6235
vbmc add overcloud-ceph01 --username admin --password admin --port 6236
vbmc add overcloud-ceph02 --username admin --password admin --port 6237
vbmc add overcloud-ceph03 --username admin --password admin --port 6238
vbmc add overcloud-networker --username admin --password admin --port 6239
